defmodule Redexor.Admins.AdminToken do
  @moduledoc false
  ...
  schema "admins_tokens" do
    ...
    belongs_to :admin, Redexor.Admins.Admin
  ...
  def build_session_token(admin) do
    ...
    {token, %Redexor.Admins.AdminToken{token: token, context: "session", admin_id: admin.id}}
  end
  ...
  def token_and_context_query(token, context) do
    from Redexor.Admins.AdminToken, where: [token: ^token, context: ^context]
  end
  ...
  def admin_and_contexts_query(admin, :all) do
    from t in Redexor.Admins.AdminToken, where: t.admin_id == ^admin.id
  end

  def admin_and_contexts_query(admin, [_ | _] = contexts) do
    from t in Redexor.Admins.AdminToken,
