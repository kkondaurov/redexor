defmodule RedexorWeb.UserSettingsControllerTest do
  ...
  describe "GET /users/settings" do
    test "renders settings page", %{conn: conn} do
      ...
      assert response_template =~ "<h1>Settings</h1>"
    end
