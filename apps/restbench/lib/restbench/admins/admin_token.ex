defmodule Restbench.Admins.AdminToken do
  ...
  schema "admins_tokens" do
    ...
    belongs_to :admin, Restbench.Admins.Admin
  ...
  def build_session_token(admin) do
    ...
    {token, %Restbench.Admins.AdminToken{token: token, context: "session", admin_id: admin.id}}
  end
  ...
  def token_and_context_query(token, context) do
    from Restbench.Admins.AdminToken, where: [token: ^token, context: ^context]
  end
  ...
  def admin_and_contexts_query(admin, :all) do
    from t in Restbench.Admins.AdminToken, where: t.admin_id == ^admin.id
  end
