defmodule Redexor.Accounts do
  ...
  alias Redexor.Accounts.{User, UserNotifier, UserToken}
  ...
  def reset_user_password(user, attrs) do
    Ecto.Multi.new()
    |> Ecto.Multi.update(:user, User.password_changeset(user, attrs) |> User.confirm_changeset())
    |> Ecto.Multi.delete_all(:tokens, UserToken.user_and_contexts_query(user, :all))
    |> Repo.transaction()
    |> case do
      {:ok, %{user: user}} -> {:ok, user}
